...
export class TsPdfViewer
{
    ...
    {
        const mcResizeObserver = new ResizeObserver((_entries: ResizeObserverEntry[]) =>
        {
    ...
    //#region misc
    private onPdfLoadingProgress = (_progressData: { loaded: number; total: number }) =>
    {
    ...
    {
        const passwordPromise = new Promise<string>((resolve, _reject) =>
        {
...
export type { AnnotationDto, AnnotEvent, AnnotEventDetail, CustomStampCreationInfo, CustomStampEventDetail, ViewerMode as TsPdfViewerMode };
